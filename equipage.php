    ...
    <section class="teamPresentation" >
        <h1>L'Equipages</h1>
            <div class="containerImageLeft" >
                <div class="imageLeft">
                    <img class="pictureVictoria" src="assets/Images/VictoriaSmall.jpg" alt="Picture of Victoria">
                </div>
            ...
            <div class="containerImageRight">
                    <div class="imageRight">
                        <img class="pictureJohann" src="assets/Images/JohannSmall.jpg" alt="Picture of Johann">
                    </div>
            ...
            <div class="containerImageLeft">
                <div class="imageLeft">
                    <img class="pictureMelissa" src="assets/Images/MelissaSmall.jpg" alt="Picture of Mélissa">
                </div>
                <div class="presentationRight">
            ...
            <div class="containerImageRight">
                <div class="imageRight">
                    <img class="pictureEtienne" src="assets/Images/EtienneSmall.jpg" alt="Picture of Etienne">
                </div>
                <div class="presentationLeft">
            ...
            <div class="containerImageLeft">
                <div class="imageLeft">
                    <img class="pictureAdeline" src="assets/Images/AdelineSmall.jpg" alt="Picture of Adeline">
                </div>
                <div class="presentationRight">
